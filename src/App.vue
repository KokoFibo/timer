<template>
  ...
  >
    ...
    <button
      @click="cycleTheme"
      class="fixed top-4 right-4 p-3 rounded-full transition-colors duration-300 shadow-lg z-50 sm:p-3 sm:right-4 sm:top-4"
      :class="{
...
@media (max-width: 640px) {
  ...
  /* Ensure the theme switcher button remains circular and positioned correctly */
  .fixed {
    top: 1rem;
    right: 1rem;
    padding: 0.75rem;
